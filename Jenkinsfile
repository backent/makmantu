    ...
    stages {
        ...
        stage('Deployment') {
            ...
            steps {
                ...
                withCredentials([file(credentialsId: 'makmantu-key', variable: 'SECRET_FILE_PATH'), string(credentialsId: 'makmantu-location', variable: 'SECRET_VPS'), "REL_VER=${params.RELEASE_VERSION}"]) {
                    sh '''
